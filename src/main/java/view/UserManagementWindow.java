...
public class UserManagementWindow extends BaseInternalFrame {
    ...
    private void setupWindow() {
        ...
        styleTextField(txtId); // Método de BaseInternalFrame
        mainPanel.add(txtId);
        ...
        // Ajustar el editor del JSpinner para que combine
        ...
        styleButton(btnSave); // Método de BaseInternalFrame (Aplica fuente y bordes)
        btnSave.setBackground(new Color(46, 204, 113)); // Verde éxito
        ...
        // Centrar en el desktop al nacer (opcional)
        setLocation(350, 50);
    }
    ...
    private JLabel createStyledLabel(String text) {
        ...
        label.setForeground(new Color(44, 62, 80)); // Azul oscuro técnico
        return label;
    }
